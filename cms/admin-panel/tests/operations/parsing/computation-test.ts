...
import type { TokenStream } from "../../../src/operations/types";
import {
  parseTokenStream,
  createTokenStream,
} from "../../../src/operations/parse-token-stream";
import type { SyntaxStream } from "../../../../../packages/api/types";
import {
  createSyntaxStream,
  parseSyntaxStream,
} from "../../../../../packages/api/parse-syntax-stream";
